...
public class HomeViewModel extends ViewModel {
    ...
    Publication[] publicaciones = {
            new Publication(1, new User("", "@jorge", "", null, ""), "Gran dia", Arrays.asList(users), R.drawable.gohan, Arrays.asList(comentarios)),
            new Publication(2, new User("", "@kashir", "", null, ""), "El crack", Arrays.asList(users), R.drawable.vegeta, Arrays.asList(comentarios)),
            new Publication(3, new User("", "@jorge2", "", null, ""), "Postureo", Arrays.asList(users), R.drawable.broly, Arrays.asList(comentarios)),
            new Publication(4, new User("", "@kashir2" , "", null, ""), "Gran dia", Arrays.asList(users), R.drawable.gogeta, Arrays.asList(comentarios)),
            new Publication(5, new User("", "@jorge3", "", null, ""), "Gran dia", Arrays.asList(users), R.drawable.gohan, Arrays.asList(comentarios)),
            new Publication(6, new User("", "@kashir3", "", null, ""), "Gran dia", Arrays.asList(users), R.drawable.lambo, Arrays.asList(comentarios)),
            new Publication(7, new User("", "@pepe", "", null, ""), "Gran dia", Arrays.asList(users), R.drawable.instagram_logo, Arrays.asList(comentarios)),
    };
